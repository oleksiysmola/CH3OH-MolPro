...
stretchesSpacing::Vector{Float64} = [-0.025,0.025, 0.050, -0.0500, -0.1000, 0.1000, 0.12500, -0.125000, 0.1500, -0.1500, 0.200, 
   -0.200, 0.300, -0.300, 0.400, 0.500, 0.600, 0.700]
symmeterisedStretchesSpacing::Vector{Float64} = [-0.025, 0.025, 0.050, -0.0500, -0.1000, 0.1000, 0.12500, -0.125000, 0.1500, -0.1500, 0.200, 
   -0.200, 0.300, -0.300, 0.400, 0.500]
angleSpacing::Vector{Float64} = [1.000, -1.000, 2.500, -2.5000, 5.0000, -5.0000, 7.500, -7.500, 10.0000, -10.0000, 20.0000, 
    -20.0000, 30.0000, -30.0000, 40.0000, -40.0000]
dihedralSpacing::Vector{Float64} = [1.000, -1.000, 2.5000, -2.5000, 5.0000, -5.0000, 7.500, -7.500, 10.0000, -10.0000, 40.0000, 
    -40.0000, 60.0000, -60.0000, 80.0000, -80.0000, 100.0000]
torsionSpacing::Vector{Float64} = [5.0000, 10.0000, 15.0000, 20.00000, 25.000, 30.0000, 35.0000, 40.0000, 45.0000, 50.0000, 55.0000, 60.0000]

spacingOfGrid::Vector{Vector{Float64}} = [stretchesSpacing, stretchesSpacing, symmeterisedStretchesSpacing, symmeterisedStretchesSpacing, symmeterisedStretchesSpacing, angleSpacing, angleSpacing, angleSpacing, angleSpacing, dihedralSpacing, dihedralSpacing, torsionSpacing]
...
function ConvertFromSymmeterisedStretches(stretchesDisplacement::Vector{Float64}, equilibriumBondLengths::Vector{Float64})::Vector{Float64}
    morseParameter::Float64 = 2.1
    stretches::Vector{Float64} = equilibriumBondLengths
    stretches[1] -= log(1 - sqrt(2/3)*stretchesDisplacement[1] + stretchesDisplacement[2]/sqrt(6) + stretchesDisplacement[3]/sqrt(2))/morseParameter
    stretches[2] -= log(1 - sqrt(2/3)*stretchesDisplacement[1] - sqrt(2/3)*stretchesDisplacement[2])/morseParameter
    stretches[3] -= log(1 - sqrt(2/3)*stretchesDisplacement[1] + stretchesDisplacement[2]/sqrt(6) - stretchesDisplacement[3]/sqrt(2))/morseParameter
    return stretches
end
...
r1SymmeterisedEq = 0.00
r2SymmeterisedEq = 0.00
r3SymmeterisedEq = 0.00
a1SymmeterisedEq = 0.00
a2SymmeterisedEq = 0.00
a3SymmeterisedEq = 0.00
